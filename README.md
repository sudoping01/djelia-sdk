# Djelia SDK Python API library

<!-- prettier-ignore -->
[![PyPI version](https://img.shields.io/pypi/v/djelia_sdk.svg?label=pypi%20(stable))](https://pypi.org/project/djelia_sdk/)

The Djelia SDK Python library provides convenient access to the Djelia SDK REST API from any Python 3.9+
...
```sh
# install from PyPI
pip install djelia_sdk[aiohttp]
```
